// lab_25_2.cpp : Определяет точку входа для приложения.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LAB252, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB252));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAB252));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_LAB252);
    ...
    case WM_PAINT:
        {
            ...
            RecImage2_1(hdc, 200, 200, 100);
            RecImage2_2(hdc, 500, 200, 100);
            RecImage2_3(hdc, 800, 200, 100);
            RecImage2_4(hdc, 200, 500, 100);
            RecImage2_5(hdc, 600, 600, 100);
            RecImage2_6(hdc, 900, 600, 100);
            RecImage2_7(hdc, 1100, 200, 100);
